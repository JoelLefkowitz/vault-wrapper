module.exports = function (grunt) {
  grunt.initConfig({
    exec: {
      bandit: "bandit --ini .bandit -r vault-wrapper",
      black: "black vault-wrapper",
      cspell: "npx cspell -c .cspell.json {*,.*,**/*}",
      isort: "isort vault-wrapper",
      mypy: "mypy vault-wrapper",
      prettier: "prettier . --write",
      pylint: "pylint --rcfile .pylintrc  --fail-under=8 vault-wrapper",
